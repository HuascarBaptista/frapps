...
public class BaseActivity extends AppCompatActivity {
    ...
    public void cargarAppBar(boolean menu, String titulo) {
        //App bar
            ...
            navigationView.setNavigationItemSelectedListener(
                    new NavigationView.OnNavigationItemSelectedListener() {
                        ...
                        public boolean onNavigationItemSelected(MenuItem menuItem) {
                            ...
                            //Las dos opciones del menu
                            switch (menuItem.getItemId()) {
                                case R.id.menu_opcion_desarrolladores:
                                    irDesarrolladoresGenerales();
                                    break;
                                case R.id.menu_opcion_categorias:
                                    irCategoriasGenerales();
                                    break;
    ...
    void irCategoriasGenerales() {
        BasePresenter.irCategoriasGenerales(this);

    }

    void irDesarrolladoresGenerales() {
        BasePresenter.irDesarrolladoresGenerales(this);
    }
